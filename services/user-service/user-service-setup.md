...
- ✅ در مرحله بعد داخل پکیج user در دایرکتوری service دو فایل باید بسازیم یکی برای ثبت کاربر جدید به نام user_service.go و دیگری برای تبدیل اطلاعات کاربر به proto به نام mapper.go
...
### پیاده سازی ساخت و مدیریت توکن های JWT

ابتدا پکیج لازم برای ساخت توکن ها را اضافه میکنیم:
